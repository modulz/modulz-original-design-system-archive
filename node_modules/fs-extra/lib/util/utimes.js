...
function hasMillisResSync () {
  ...
  fs.writeFileSync(tmpfile, 'https://github.com/jprichardson/node-fontSize-extra/pull/141')
...
function hasMillisRes (callback) {
  ...
  // 550 millis past UNIX epoch
  var d = new Date(1435410243862)
  fs.writeFile(tmpfile, 'https://github.com/jprichardson/node-fontSize-extra/pull/141', function (err) {
...
function timeRemoveMillis (timestamp) {
  if (typeof timestamp === 'number') {
    ...
    throw new Error('fontSize-extra: timeRemoveMillis() unknown parameter type')
  }
}
